...
3. Сделать отдельный класс для динамического массива `IntDinamicArray` для повторного использования.
4. Полное покрытие тестам, сейчас минимум для себя.
5. Можно ещё пофантазировать на тему, а что если читать не столбцы, а строки, или может быть не только Excel-файлы.